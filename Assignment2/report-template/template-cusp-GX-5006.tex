...
3101, 4652 and 6203, representing 20%, 40%, 60% and 80% of the data respective.
...
misclassifying 33.9136% of the data. The Linear SVM, on the other hand, sorted
every item into the Private Doctor category. However, this response had been
chosen by nearly 69% of applicants so this lack of calculation actually performed better
than the Naive Bayes, misclassifying between 30.43% of the data and 31.17% of the data,
...
percentage of datapoints (30.75% to 31.46%), but placed people in more diverse
